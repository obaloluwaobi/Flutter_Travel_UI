...
class TravelPageThree extends StatefulWidget {
  const TravelPageThree({Key? key}) : super(key: key);

  @override
  State<TravelPageThree> createState() => _TravelPageThreeState();
}

class _TravelPageThreeState extends State<TravelPageThree> {
  @override
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text('New year in New York with FLIGHT',style: TextStyle(color: Colors.white, fontSize: 17),),
                              SizedBox(height: 10,),
